...
% UPDATED ... Jul. 31/2017                                                %
%                                                                         %
% This function will generate a random anti-tridiagonal matrix where the  %
...
%                                                                         %
% OUTPUT                                                                  %
%   An nxn anti-tridiagonal matrix where the entries are randomly sampled %
...
% ----------------------------------------------------------------------- %
function A = randomAntiTridiagonalMatrix(population, n)
