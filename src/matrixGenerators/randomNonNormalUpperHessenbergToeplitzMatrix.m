...
% with a Toeplitz structurewhere the entries are sampled from a given     %
% list.                                                                   %
%                                                                         %
% INPUT                                                                   %
...
%                                                                         %
% OUTPUT                                                                  %
%   An nxn non-normal upper-hessenberg Toeplitz matrix with entries       %
...
% ----------------------------------------------------------------------- %
function A = randomNonNormalUpperHessenbergToeplitzMatrix(population, n)
    while true
